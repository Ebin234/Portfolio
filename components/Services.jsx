...
function Services({ isDarkMode }) {
  return (
    ...
    >
      ...
      >
        I’m a full-stack developer from Kerala, India, with 2 years of project
        experience across various domains, including front-end development,
        back-end development, and smart contract development.
      </motion.p>
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
