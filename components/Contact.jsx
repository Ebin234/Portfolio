...
function Contact({ isDarkMode }) {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "4e4522c8-17ee-44fb-8c9c-21346a14aacb");
  ...
  return (
    ...
    >
      ...
      >
        ...
        outline-none border-[0.5px] border-gray-400 rounded-md bg-white  dark:bg-darkHover/30 dark:border-white/90"
            name="email"
          />
        </div>
        <motion.textarea
        ...
        outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6  dark:bg-darkHover/30 dark:border-white/90"
          name="message"
        ></motion.textarea>
        <motion.button
         ...
         bg-black/80 text-white rounded-full mx-auto cursor-pointer hover:bg-black duration-500 
